...
public class ElevatorIOSim implements ElevatorIO {
    ...
    private ProfiledPIDController pid = new ProfiledPIDController(0, 0, 0, new Constraints(5.0, 10.0));
    ...
    public void setPositionSetpoint(double positionMeters) {
        setVoltage(pid.calculate(physicsSim.getPositionMeters(), positionMeters) + feedforward.calculate(pid.getSetpoint().velocity));
    }
