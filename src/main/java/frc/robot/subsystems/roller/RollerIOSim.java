...
public class RollerIOSim implements RollerIO {
    ...
    public RollerIOSim(double jKgMetersSquared, double gearing, SimpleMotorFeedforward feedforward, ProfiledPIDController positionPID, ProfiledPIDController velocityPID) {
        physicsSim = new DCMotorSim(LinearSystemId.createDCMotorSystem(DCMotor.getKrakenX60Foc(1), jKgMetersSquared, gearing), 
    ...
    public void setVelocitySetpoint(double velocityRotationsPerSecond) {
        physicsSim.setInputVoltage(
            velocityPID.calculate(physicsSim.getAngularVelocity().in(RotationsPerSecond), velocityRotationsPerSecond)
